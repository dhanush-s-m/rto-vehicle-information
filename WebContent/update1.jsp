...
<center>
<a  href="profil.html"  align="center"><font style=color:white> Back </font> </a>
</center>
...
int i=0;
if(vname!=null &&vcatg!=null &&cname!=null &&color!=null &&chnum!=null  ){
	if(vname!="" &&vcatg!="" &&cname!="" &&color!="" &&chnum!=""  ){
...
try
 {
   ...
   i=st.executeUpdate();
	...
	if(i!=0)
	{
    	 ...
    	 out.println("<script>alert('Updated Sucessfully');window.location='update.jsp';</script>");
