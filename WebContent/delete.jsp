	...
	//out.println(n);
	    	...
	    	PreparedStatement statement4=con.prepareStatement(q4);
             ...
             if(i>0 && j>0 && k>0 && l>0 && m>0){
            	 out.println("<script>alert('deleted sucessfully');window.location='delete.html';</script>");
             }
	}
	else
	{
   	 out.println("<script>alert('NOT RECORDS FOUND TO DELETE');window.location='delete.html';</script>");
